...
interface IDatabase {
    ...
    ArrayList<String[]> get(String header, String value, boolean lenient) throws DatabaseNotFoundException;

    ArrayList<String[]> getAll() throws DatabaseNotFoundException;
